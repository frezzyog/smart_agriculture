    ...
    return (
        <Card className="p-6 bg-[#0a0f0b] border-white/5 relative overflow-hidden group">
            <div className="flex items-center justify-between mb-6">
                <div>
                    <h3 className="text-sm font-bold text-white uppercase tracking-wider">Digital Twin Viewer</h3>
                    <p className="text-[10px] text-gray-500">Spatial analysis: {zoneId || 'Select Zone'}</p>
                </div>
            </div>

            <div className="aspect-[4/3] bg-white/[0.02] rounded-2xl border border-dashed border-white/10 relative overflow-hidden">
                {/* Grid Overlay */}
                ...
                {layout.map((item, i) => (
                    ...
                    >
                        ...
                        <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 hidden group-hover/item:block z-50">
                            <div className="bg-[#0a0f0b] border border-white/10 p-2 rounded-lg text-[9px] whitespace-nowrap shadow-2xl">
